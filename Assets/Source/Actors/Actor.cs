...
namespace DungeonCrawl.Actors
{
    public abstract class Actor : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            Color blobColor = new(153, 50, 204);
            ActorManager.Singleton.ColorTile("Blob", blobColor);
            ActorManager.Singleton.ColorTile("Floor", Color.grey);
            ActorManager.Singleton.ColorTile("Potion", Color.red);
